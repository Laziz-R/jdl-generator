...
public class TaskService {
    ...
    */
    public TaskService (Vertx vertx){
        ...
        this.vertx = vertx;
        JsonObject dbConfig = vertx.getOrCreateContext().config().getJsonObject("TaskService").getJsonObject("db");
    ...
    public Future<BookList> bookGetAll(UserCredentials uc) {
        return this.bookCommand
    ...
    public Future<AuthorList> authorGetAll(UserCredentials uc) {
        return this.authorCommand
    ...
    public Future<BookAuthorList> bookAuthorGetAll(UserCredentials uc) {
        return this.bookAuthorCommand
