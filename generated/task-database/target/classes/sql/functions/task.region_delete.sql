DROP FUNCTION IF EXISTS task.region_delete;
CREATE FUNCTION task.region_delete(
  in_login_id BIGINT,
  in_region_id BIGINT
  )
RETURNS BIGINT
AS $$
/******************************************************************************
**		File: task.region_delete.sql
**		Name: task.region_delete
**		Desc: delete region
*******************************************************************************
**		Auth: laziz
**		Date: 2021-08-09
...
*******************************************************************************
**/
  DECLARE FN_NAME CONSTANT TEXT := 'task.region_delete';
  STEP_INDEX INTEGER;
