DROP FUNCTION IF EXISTS task.job_get_list;
CREATE FUNCTION task.job_get_list(
    in_login_id BIGINT,
    in_skip BIGINT,
    in_page_size BIGINT
    )
...
AS $$
/******************************************************************************
**		File: task.job_get_list.sql
**		Name: task.job_get_list
**		Desc: Get jobs data
*******************************************************************************
**		Auth: laziz
**		Date: 2021-08-09
...
**/
  ...
  DECLARE FN_NAME CONSTANT TEXT := 'task.job_get_list';
  STEP_INDEX INTEGER;
