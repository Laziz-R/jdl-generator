DROP FUNCTION IF EXISTS task.job_task_update;
CREATE FUNCTION task.job_task_update(
    in_login_id BIGINT,
...
AS $$
/******************************************************************************
**		File: task.job_task_update.sql
**		Name: task.job_task_update
...
*******************************************************************************
**/
  DECLARE FN_NAME CONSTANT TEXT := 'task.job_task_update';
  STEP_INDEX INTEGER;
