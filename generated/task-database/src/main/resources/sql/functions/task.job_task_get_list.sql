DROP FUNCTION IF EXISTS task.job_task_get_list;
CREATE FUNCTION task.job_task_get_list(
    in_login_id BIGINT,
    in_skip BIGINT,
    in_page_size BIGINT
    )
...
AS $$
/******************************************************************************
**		File: task.job_task_get_list.sql
**		Name: task.job_task_get_list
...
**/
  ...
  DECLARE FN_NAME CONSTANT TEXT := 'task.job_task_get_list';
  STEP_INDEX INTEGER;
